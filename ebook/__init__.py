...
from .image import get_image_from_url, download_from_url_and_convert_image, convert_image
        ...
        if hasattr(chapter, '__iter__'):
            ...
            for count, img in enumerate(all_images):
                if not img.has_attr('src'):
                    ...
                    continue
                print(f"Converting image {count} out of {len_of_all_images} from chapter {i}")
                print(img)
